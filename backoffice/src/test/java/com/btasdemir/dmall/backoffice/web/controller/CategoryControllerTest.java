...
import com.btasdemir.dmall.backoffice.web.controller.CategoryController;
...
public class CategoryControllerTest extends BackofficeBaseTest {
	...
	public void testGetCategories() {
		...
		assertEquals(resultCategories.get(0), categories.get(0));
	}
	
	@Test
	public void testSave() {
		DaoResult<CategoryDto> daoResult = new DaoResult<>(category);
		
		when(categoryService.save(any(CategoryDto.class))).thenReturn(daoResult);
		
		String resultPath = controller.save();
		
		assertEquals(resultPath, "/category-list.xhtml?faces-redirect=true");
	}
	
	@Test
	public void testGetCategory() {
		CategoryDto resultCategory = controller.getCategory();
